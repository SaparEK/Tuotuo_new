...
// Hero CTA and stats
extend(ru, {
  "hero.cta": "Оставить заявку на доставку груза",
  "hero.stats.years": "лет на рынке",
  "hero.stats.ontime": "доставок вовремя",
  "hero.stats.support": "поддержка",
  "modal.title": "Оставить заявку",
  "modal.subtitle": "Оставьте телефон и мы перезвоним",
  "modal.calltime": "В какое время вам позвонить?",
  "modal.calltime.now": "Сейчас",
  "modal.calltime.hour": "В течение часа",
  "modal.calltime.today": "Сегодня до 18:00",
  "modal.calltime.tomorrow": "Завтра",
  "modal.name": "Ваше имя",
  "modal.phone": "Ваш номер телефона",
  "modal.email": "Ваш e-mail",
  "modal.submit": "Жду звонка",
  "modal.consent.prefix": "Согласен с",
  "modal.consent.terms": "условиями",
  "modal.consent.and": "и",
  "modal.consent.policy": "политикой конфиденциальности",
});

extend(en, {
  "hero.cta": "Request a shipping quote",
  "hero.stats.years": "years on the market",
  "hero.stats.ontime": "deliveries on time",
  "hero.stats.support": "support",
  "modal.title": "Leave a request",
  "modal.subtitle": "Leave your phone and we will call you back",
  "modal.calltime": "When should we call you?",
  "modal.calltime.now": "Now",
  "modal.calltime.hour": "Within an hour",
  "modal.calltime.today": "Today before 6 pm",
  "modal.calltime.tomorrow": "Tomorrow",
  "modal.name": "Your name",
  "modal.phone": "Your phone number",
  "modal.email": "Your e-mail",
  "modal.submit": "Request a call",
  "modal.consent.prefix": "I agree with",
  "modal.consent.terms": "the terms",
  "modal.consent.and": "and",
  "modal.consent.policy": "the privacy policy",
});

extend(zh, {
  "hero.cta": "提交运输需求",
  "hero.stats.years": "年行业经验",
  "hero.stats.ontime": "按时交付",
  "hero.stats.support": "全天候支持",
  "modal.title": "提交申请",
  "modal.subtitle": "留下电话，我们将回电",
  "modal.calltime": "我们何时致电？",
  "modal.calltime.now": "现在",
  "modal.calltime.hour": "一小时内",
  "modal.calltime.today": "今日 18:00 前",
  "modal.calltime.tomorrow": "明天",
  "modal.name": "您的姓名",
  "modal.phone": "您的电话",
  "modal.email": "您的邮箱",
  "modal.submit": "等待来电",
  "modal.consent.prefix": "同意",
  "modal.consent.terms": "条款",
  "modal.consent.and": "及",
  "modal.consent.policy": "隐私政策",
});
...
// GeoCoverage region translations
extend(ru, {
  ...
  "geo.regions.kz.highlights.0": "Сборные и FTL",
  "geo.regions.kz.highlights.1": "Таможенное оформление",
  "geo.regions.kz.highlights.2": "Транзит через КЗ",
  "geo.regions.kz.hubs.0": "Алматы",
  "geo.regions.kz.hubs.1": "Астана",
  "geo.regions.kz.hubs.2": "Шымкент",
  "geo.regions.kz.hubs.3": "Караганда",
  "geo.regions.kz.services.0": "Авто и рефрижераторы",
  "geo.regions.kz.services.1": "Консолидация",
  "geo.regions.kz.services.2": "Складская обработка",
  "geo.regions.kz.services.3": "Страхование",
  ...
  "geo.regions.uz.highlights.0": "Консолидация",
  "geo.regions.uz.highlights.1": "Растаможка",
  "geo.regions.uz.highlights.2": "Отслеживание",
  "geo.regions.uz.hubs.0": "Ташкент",
  "geo.regions.uz.hubs.1": "Самарканд",
  "geo.regions.uz.hubs.2": "Бухара",
  "geo.regions.uz.hubs.3": "Наманган",
  "geo.regions.uz.services.0": "FTL/LTL",
  "geo.regions.uz.services.1": "Сертификация",
  "geo.regions.uz.services.2": "Внутригородская доставка",
  "geo.regions.uz.services.3": "Страхование",
  ...
  "geo.regions.tm.highlights.0": "Экспорт/импорт",
  "geo.regions.tm.highlights.1": "Маршруты под проект",
  "geo.regions.tm.highlights.2": "Документы",
  "geo.regions.tm.hubs.0": "Ашхабад",
  "geo.regions.tm.hubs.1": "Туркменабад",
  "geo.regions.tm.hubs.2": "Балканабат",
  "geo.regions.tm.services.0": "Мультимодальные схемы",
  "geo.regions.tm.services.1": "Транзит через КЗ/РФ",
  "geo.regions.tm.services.2": "Проектные грузы",
  "geo.regions.kg.title": "Кыргызстан",
  "geo.regions.kg.description": "Рейсы в Бишкек, Ош и регионы. Опыт работы с СЭЗ и кросс‑бордер.",
  "geo.regions.kg.highlights.0": "СЭЗ",
  "geo.regions.kg.highlights.1": "Кросс‑бордер",
  "geo.regions.kg.highlights.2": "Сроки",
  "geo.regions.kg.hubs.0": "Бишкек",
  "geo.regions.kg.hubs.1": "Ош",
  "geo.regions.kg.hubs.2": "Кара‑Балта",
  "geo.regions.kg.services.0": "Сборные грузы",
  "geo.regions.kg.services.1": "Склад‑кроссдок",
  "geo.regions.kg.services.2": "Таможенное сопровождение",
  ...
  "geo.regions.cn.highlights.0": "Опыт с кросс-бордер",
  "geo.regions.cn.highlights.1": "Проверенные партнеры",
  "geo.regions.cn.highlights.2": "Сроки от 7 дней",
  "geo.regions.cn.hubs.0": "Урумчи",
  "geo.regions.cn.hubs.1": "Иу",
  "geo.regions.cn.hubs.2": "Гуанчжоу",
  "geo.regions.cn.hubs.3": "Шэньчжэнь",
  "geo.regions.cn.services.0": "Авто/жд",
  "geo.regions.cn.services.1": "Промтаможня",
  "geo.regions.cn.services.2": "Проверка качества",
  "geo.regions.cn.services.3": "Консолидация",
  ...
  "geo.regions.ru.highlights.0": "Отгрузки 24/7",
  "geo.regions.ru.highlights.1": "Холодная цепь при необходимости",
  "geo.regions.ru.highlights.2": "Складская логистика",
  "geo.regions.ru.hubs.0": "Москва",
  "geo.regions.ru.hubs.1": "Санкт‑Петербург",
  "geo.regions.ru.hubs.2": "Екатеринбург",
  "geo.regions.ru.hubs.3": "Новосибирск",
  "geo.regions.ru.services.0": "FTL/LTL",
  "geo.regions.ru.services.1": "Фулфилмент",
  "geo.regions.ru.services.2": "Рефрижераторы",
  "geo.regions.ru.services.3": "Страхование",
});

extend(en, {
  "geo.regions.kz.title": "Kazakhstan",
  "geo.regions.kz.description": "Transportation across Kazakhstan and transit to neighboring countries. Hubs: Almaty, Astana, Shymkent.",
  "geo.regions.kz.highlights.0": "LTL and FTL",
  "geo.regions.kz.highlights.1": "Customs clearance",
  "geo.regions.kz.highlights.2": "Transit through KZ",
  "geo.regions.kz.hubs.0": "Almaty",
  "geo.regions.kz.hubs.1": "Astana",
  "geo.regions.kz.hubs.2": "Shymkent",
  "geo.regions.kz.hubs.3": "Karaganda",
  "geo.regions.kz.services.0": "Trucks and refrigerators",
  "geo.regions.kz.services.1": "Consolidation",
  "geo.regions.kz.services.2": "Warehouse processing",
  "geo.regions.kz.services.3": "Insurance",
  ...
  "geo.regions.uz.highlights.0": "Consolidation",
  "geo.regions.uz.highlights.1": "Customs clearance",
  "geo.regions.uz.highlights.2": "Tracking",
  "geo.regions.uz.hubs.0": "Tashkent",
  "geo.regions.uz.hubs.1": "Samarkand",
  "geo.regions.uz.hubs.2": "Bukhara",
  "geo.regions.uz.hubs.3": "Namangan",
  "geo.regions.uz.services.0": "FTL/LTL",
  "geo.regions.uz.services.1": "Certification",
  "geo.regions.uz.services.2": "Intracity delivery",
  "geo.regions.uz.services.3": "Insurance",
  "geo.regions.tm.title": "Turkmenistan",
  "geo.regions.tm.description": "Working with Ashgabat and industrial regions. Export/import and transit.",
  "geo.regions.tm.highlights.0": "Export/import",
  "geo.regions.tm.highlights.1": "Project routes",
  "geo.regions.tm.highlights.2": "Documentation",
  "geo.regions.tm.hubs.0": "Ashgabat",
  "geo.regions.tm.hubs.1": "Turkmenabat",
  "geo.regions.tm.hubs.2": "Balkanabat",
  "geo.regions.tm.services.0": "Multimodal schemes",
  "geo.regions.tm.services.1": "Transit through KZ/RF",
  "geo.regions.tm.services.2": "Project cargo",
  ...
  "geo.regions.kg.highlights.0": "SEZ",
  "geo.regions.kg.highlights.1": "Cross-border",
  "geo.regions.kg.highlights.2": "Timing",
  "geo.regions.kg.hubs.0": "Bishkek",
  "geo.regions.kg.hubs.1": "Osh",
  "geo.regions.kg.hubs.2": "Kara-Balta",
  "geo.regions.kg.services.0": "LTL cargo",
  "geo.regions.kg.services.1": "Warehouse cross-dock",
  "geo.regions.kg.services.2": "Customs escort",
  ...
  "geo.regions.cn.highlights.0": "Cross-border experience",
  "geo.regions.cn.highlights.1": "Verified partners",
  "geo.regions.cn.highlights.2": "Delivery from 7 days",
  "geo.regions.cn.hubs.0": "Urumqi",
  "geo.regions.cn.hubs.1": "Yiwu",
  "geo.regions.cn.hubs.2": "Guangzhou",
  "geo.regions.cn.hubs.3": "Shenzhen",
  "geo.regions.cn.services.0": "Truck/rail",
  "geo.regions.cn.services.1": "Industrial customs",
  "geo.regions.cn.services.2": "Quality inspection",
  "geo.regions.cn.services.3": "Consolidation",
  "geo.regions.ru.title": "Russia",
  "geo.regions.ru.description": "Regular flights across Central and Siberian parts of the Russian Federation. Door-to-door delivery with tracking.",
  "geo.regions.ru.highlights.0": "24/7 shipments",
  "geo.regions.ru.highlights.1": "Cold chain when needed",
  "geo.regions.ru.highlights.2": "Warehouse logistics",
  "geo.regions.ru.hubs.0": "Moscow",
  "geo.regions.ru.hubs.1": "St. Petersburg",
  "geo.regions.ru.hubs.2": "Yekaterinburg",
  "geo.regions.ru.hubs.3": "Novosibirsk",
  "geo.regions.ru.services.0": "FTL/LTL",
  "geo.regions.ru.services.1": "Fulfillment",
  "geo.regions.ru.services.2": "Refrigerators",
  "geo.regions.ru.services.3": "Insurance",
});

extend(zh, {
  "geo.regions.kz.title": "哈萨克斯坦",
  "geo.regions.kz.description": "哈萨克斯坦境内运输及邻国过境。枢纽：阿拉木图、阿斯塔纳、奇姆肯特。",
  "geo.regions.kz.highlights.0": "零担和整车",
  "geo.regions.kz.highlights.1": "清关",
  "geo.regions.kz.highlights.2": "哈萨克斯坦过境",
  "geo.regions.kz.hubs.0": "阿拉木图",
  "geo.regions.kz.hubs.1": "阿斯塔纳",
  "geo.regions.kz.hubs.2": "奇姆肯特",
  "geo.regions.kz.hubs.3": "卡拉干达",
  "geo.regions.kz.services.0": "卡车和冷藏车",
  "geo.regions.kz.services.1": "拼箱",
  "geo.regions.kz.services.2": "仓储处理",
  "geo.regions.kz.services.3": "保险",
  "geo.regions.uz.title": "乌兹别克斯坦",
  "geo.regions.uz.description": "塔什干、撒马尔罕、布哈拉往返路线。拼箱和门到门配送。",
  "geo.regions.uz.highlights.0": "拼箱",
  "geo.regions.uz.highlights.1": "清关",
  "geo.regions.uz.highlights.2": "跟踪",
  "geo.regions.uz.hubs.0": "塔什干",
  "geo.regions.uz.hubs.1": "撒马尔罕",
  "geo.regions.uz.hubs.2": "布哈拉",
  "geo.regions.uz.hubs.3": "纳曼干",
  "geo.regions.uz.services.0": "整车/零担",
  "geo.regions.uz.services.1": "认证",
  "geo.regions.uz.services.2": "市内配送",
  "geo.regions.uz.services.3": "保险",
  "geo.regions.tm.title": "土库曼斯坦",
  "geo.regions.tm.description": "与阿什哈巴德和工业地区合作。进出口和过境。",
  "geo.regions.tm.highlights.0": "进出口",
  "geo.regions.tm.highlights.1": "项目路线",
  "geo.regions.tm.highlights.2": "文件",
  "geo.regions.tm.hubs.0": "阿什哈巴德",
  "geo.regions.tm.hubs.1": "土库曼纳巴德",
  "geo.regions.tm.hubs.2": "巴尔卡纳巴特",
  "geo.regions.tm.services.0": "多式联运",
  "geo.regions.tm.services.1": "哈萨克斯坦/俄罗斯过境",
  "geo.regions.tm.services.2": "项目货物",
  "geo.regions.kg.title": "吉尔吉斯斯坦",
  "geo.regions.kg.description": "比什凯克、奥什和地区航班。经济特区和跨境经验。",
  "geo.regions.kg.highlights.0": "经济特区",
  "geo.regions.kg.highlights.1": "跨境",
  "geo.regions.kg.highlights.2": "时效",
  "geo.regions.kg.hubs.0": "比什凯克",
  "geo.regions.kg.hubs.1": "奥什",
  "geo.regions.kg.hubs.2": "卡拉-巴尔塔",
  "geo.regions.kg.services.0": "零担货物",
  "geo.regions.kg.services.1": "仓储交叉转运",
  "geo.regions.kg.services.2": "海关护送",
  "geo.regions.cn.title": "中国",
  "geo.regions.cn.description": "中国主要枢纽陆运：乌鲁木齐、义乌、广州、深圳。进出口。",
  "geo.regions.cn.highlights.0": "跨境经验",
  "geo.regions.cn.highlights.1": "验证合作伙伴",
  "geo.regions.cn.highlights.2": "7天起配送",
  "geo.regions.cn.hubs.0": "乌鲁木齐",
  "geo.regions.cn.hubs.1": "义乌",
  "geo.regions.cn.hubs.2": "广州",
  "geo.regions.cn.hubs.3": "深圳",
  "geo.regions.cn.services.0": "卡车/铁路",
  "geo.regions.cn.services.1": "工业清关",
  "geo.regions.cn.services.2": "质量检验",
  "geo.regions.cn.services.3": "拼箱",
  "geo.regions.ru.title": "俄罗斯",
  "geo.regions.ru.description": "俄罗斯联邦中部和西伯利亚地区定期航班。门到门配送跟踪。",
  "geo.regions.ru.highlights.0": "24/7发货",
  "geo.regions.ru.highlights.1": "必要时冷链",
  "geo.regions.ru.highlights.2": "仓储物流",
  "geo.regions.ru.hubs.0": "莫斯科",
  "geo.regions.ru.hubs.1": "圣彼得堡",
  "geo.regions.ru.hubs.2": "叶卡捷琳堡",
  "geo.regions.ru.hubs.3": "新西伯利亚",
  "geo.regions.ru.services.0": "整车/零担",
  "geo.regions.ru.services.1": "履约",
  "geo.regions.ru.services.2": "冷藏车",
  "geo.regions.ru.services.3": "保险",
});

// Footer extended translations
extend(ru, {
  "footer.company.description": "Надёжные логистические решения: авто перевозки, таможенное оформление, склад и фулфилмент. Надёжно, прозрачно, вовремя.",
  "footer.services.heading": "Услуги",
  "footer.services.items.0": "Авто перевозки",
  "footer.services.items.1": "Таможенное оформление",
  "footer.services.items.2": "Складские услуги",
  "footer.services.items.3": "Фулфилмент",
  "footer.services.items.4": "Контейнерные перевозки",
  "footer.contacts.heading": "Контакты",
  "footer.addressValue": "Жаркент, Казахстан",
  "footer.copy_base": "© 2025 TuoTuoKz.",
  "footer.copyright": "© 2025 TuoTuoKz. Все права защищены.",
});

extend(en, {
  "footer.company.description": "Reliable logistics solutions: trucking, customs clearance, warehousing and fulfillment. Reliable, transparent, on time.",
  "footer.services.heading": "Services",
  "footer.services.items.0": "Trucking",
  "footer.services.items.1": "Customs clearance",
  "footer.services.items.2": "Warehousing",
  "footer.services.items.3": "Fulfillment",
  "footer.services.items.4": "Container shipping",
  "footer.contacts.heading": "Contacts",
  "footer.addressValue": "Zharkent, Kazakhstan",
  "footer.copy_base": "© 2025 TuoTuoKz.",
  "footer.copyright": "© 2025 TuoTuoKz. All rights reserved.",
});

extend(zh, {
  "footer.company.description": "可靠的物流解决方案：公路运输、清关、仓储与履约。可靠、透明、准时。",
  "footer.services.heading": "服务",
  "footer.services.items.0": "公路运输",
  "footer.services.items.1": "清关",
  "footer.services.items.2": "仓储服务",
  "footer.services.items.3": "履约",
  "footer.services.items.4": "集装箱运输",
  "footer.contacts.heading": "联系方式",
  "footer.addressValue": "扎尔肯特，哈萨克斯坦",
  "footer.copy_base": "© 2025 TuoTuoKz.",
  "footer.copyright": "© 2025 TuoTuoKz. 版权所有。",
});
...
extend(ru, { 
  ...
  "contacts.office.addressValue": "Казахстан, г. Жаркент, ул. Абая, 63",
...
extend(en, { 
  ...
  "contacts.office.addressValue": "Kazakhstan, Zharkent, Abay St, 63",
...
extend(zh, { 
  ...
  "contacts.office.addressValue": "哈萨克斯坦，扎尔肯特，阿拜街63号",
